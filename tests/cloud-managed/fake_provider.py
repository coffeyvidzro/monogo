...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if parsed.path == "/v3/countries":
            self.reply(
                200, {"data": [resource("country-us", "countries", {"iso": "US"})]}
            )
                ...
                200,
                {
                    "data": [
                        resource(
                            ...
                            {
                                "did_group": {
                                    "data": {"id": "group-1", "type": "did_groups"}
                                }
                            },
                        )
                    ],
    ...
    def do_PATCH(self):
        ...
        relationships = {
            "voice_in_trunk": {"data": {"id": trunk, "type": "voice_in_trunks"}}
        }
        self.reply(
            200, {"data": resource("did-1", "dids", {"number": DID}, relationships)}
        )
